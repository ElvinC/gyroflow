...
class GPMFStabilizer:
	...
	def renderfile(self, outpath = "Stabilized.mp4", out_size = (1920,1080)):
		...
		self.cap.set(cv2.CAP_PROP_POS_FRAMES, 1700)
...
if __name__ == "__main__":
	...
	stab = GPMFStabilizer("test_clips/GX010010.MP4", "camera_presets/gopro_calib2.JSON")
	#stab.stabilization_settings(smooth = 0.8)
	stab.auto_sync_stab(0.8,24*30, 120 * 30, 70)
	#stab.optical_flow_comparison(start_frame=1300, analyze_length = 50)
	stab.renderfile("parkinglot2_stab.mp4",out_size = (2560,1440))
	stab.release()
